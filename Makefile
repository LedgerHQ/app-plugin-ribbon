...
ICONNAME=icons/nanos_app_ribbon.gif
else ifeq ($(TARGET_NAME), TARGET_STAX)
ICONNAME=icons/stax_app_ribbon.gif
DEFINES += ICONGLYPH=C_stax_ribbon_64px
DEFINES += ICONBITMAP=C_stax_ribbon_64px_bitmap
GLYPH_FILES += $(ICONNAME)
else
ICONNAME=icons/nanox_app_ribbon.gif
endif
